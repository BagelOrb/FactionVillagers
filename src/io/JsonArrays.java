...
public class JsonArrays {
	...
	public static JsonArray toJsonArray(Object[] ts) {
		...
		for (Object o : ts)
			if (Object[].class.isInstance(o)) builder.add(toJsonArray((Object[]) o));
				...
				builder.add(((JsonAble<?>) o).toJsonObjectBuilder());
		return builder.build();
	}
	...
	public static <T extends JsonAble<T>> T[] fromJsonArray1D(Class<T> clazz, JsonArray jre, Object... constructorParameters) throws IllegalArgumentException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
...
//				newInst = generics.Reflect.newClassInstance(clazz); // it shouldn't be a member class
	...
	@SuppressWarnings("unchecked")
	public static <T extends JsonAble<T>> T[][] fromJsonArray2D(Class<T> clazz, JsonArray jre, Object... parameters) throws IllegalArgumentException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	...
	@SuppressWarnings("unchecked")
	public static <T extends JsonAble<T>> T[][][] fromJsonArray3D(Class<T> clazz, JsonArray jre, Object... parameters) throws IllegalArgumentException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		ArrayList<T[][]> l = new ArrayList<T[][]>();
		for ( int i = 0; i<jre.size(); i++)
	...
	@SuppressWarnings("unchecked")
	public static <T extends JsonAble<T>> T[][][][] fromJsonArray4D(Class<T> clazz, JsonArray jre, Object... parameters) throws IllegalArgumentException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		ArrayList<T[][][]> l = new ArrayList<T[][][]>();
		for ( int i = 0; i<jre.size(); i++)
