...
public class Smeltery extends HomeWorkBuilding {
...
//		return "Bakery";
//	}
	static final String configYmlPath = configYmlPath_building+".smeltery";
	@Override
	...
	public Smeltery(City city, Block b) {
		super(city, b);
	}
