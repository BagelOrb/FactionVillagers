...
public class MinersLodge extends ChestBuilding {

	static final String configYmlPath = configYmlPath_building+".minersLodge";
	@Override
...
//						"woodcutterNPC id="+((woodcutterNPC==null)? "null" : this.woodcutterNPC.getId())+"\n";
	...
	public MinersLodge(City city, Block b) {
		super(city, b);
//		requirements.add(BuildingRequirement.hasMaterial(Material.BED_BLOCK));
	...
	public BuildingType getBuildingType() {
		return BuildingType.MINERS_LODGE;
	}
