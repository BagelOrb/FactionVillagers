...
public class SheepFarm extends ChestBuilding {

	static final String configYmlPath = configYmlPath_building+".sheepFarm";
	@Override
	...
	public CharacterType getCharacterType() {
		return CharacterType.SHEEP_HERDER;
	}
...
//						"woodcutterNPC id="+((woodcutterNPC==null)? "null" : this.woodcutterNPC.getId())+"\n";
	...
	public SheepFarm(City city, Block b) {
		super(city, b);
