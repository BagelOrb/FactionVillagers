...
public class ChickenFarm extends ChestBuilding {

	static final String configYmlPath = configYmlPath_building+".chickenFarm";
	@Override
	...
	public CharacterType getCharacterType() {
		return CharacterType.CHICKEN_FARMER;
	}
...
//						"woodcutterNPC id="+((woodcutterNPC==null)? "null" : this.woodcutterNPC.getId())+"\n";
	...
	public ChickenFarm(City city, Block b) {
		super(city, b);
//		requirements.add(BuildingRequirement.hasMaterial(Material.BED_BLOCK));
	...
	public BuildingType getBuildingType() {
		return BuildingType.CHICKEN_FARM;
	}
